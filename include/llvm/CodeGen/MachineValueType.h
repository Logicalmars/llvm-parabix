...
namespace llvm {
  ...
  public:
	...
	v16f64		=  99,
      ...
      x86mmx         =  100,   // This is an X86 MMX value

      Glue           =  101,   // This glues nodes together during pre-RA sched

      isVoid         =  102,   // This has no value

      Untyped        =  103,   // This value takes a register, but has
            // unspecified type.  The register class
            // will be determined by the opcode.

      LAST_VALUETYPE =  104,   // This always remains at the end of the list.
